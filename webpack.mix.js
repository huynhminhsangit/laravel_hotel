...
], 'public/admin/asset/combine-all-asset.min.css');
mix.combine([
    'public/admin/css/font-awesome/css/font-awesome.min.css',
    'public/admin/css/custom.min.css',
], 'public/admin/css/combine-all-css.min.css');
// ========== JS =========
mix.combine([
...
], 'public/admin/asset/combine-all-asset.min.js');
mix.combine([
    'public/admin/js/jquery/dist/jquery.min.js',
    'public/admin/js/fastclick/lib/fastclick.js',
    'public/admin/js/ckeditor/ckeditor.js',
    'public/admin/js/notify/notify.min.js',
], 'public/admin/js/combine-all-js.min.js');
// =================== FRONTEND ===================
