$(document).ready(function() {
    ...
    function update_book_info () {
        ...
        if(diffDay < 0) {
            ...
            var price = $('input[name=room_price]').val();
            var totalPrice = (price * diffDay).toLocaleString();
            $('span#time_check').text(diffDay+' ngày '+diffDay+' đêm');
            $('span#total_price').text(totalPrice+'đ');
        }
    }
    /*datepicker*/
    $(function() {
