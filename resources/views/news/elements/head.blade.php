...
<link rel="stylesheet" type="text/css" href="{{asset('news/css/my-style.css'. '?v=' . time())}}">
<link rel="stylesheet" type="text/css" href="{{asset('news/css/contact.css')}}">
<link rel="stylesheet" type="text/css" href="{{ asset('login123/css/my-login.css') }}">
