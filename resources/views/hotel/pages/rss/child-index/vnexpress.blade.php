@php
    ...
    $i     = 1;
    $xhtml = '<div id="vnexpress" class="tabcontent" style="display: block;"><div class="posts">';
    foreach ($xml->channel->item as $item) {
        if($i == 6)  break;
        $link  = $item->link;
        $title = $item->title;
        $pubDate = $item->pubDate;
        $pregMatch = preg_match_all('#.*src="(.*)".*br>(.*)<end>#imsU', $item->description . '<end>', $matches);
        $image       = $matches[1][0];
                    ...
                    <div class="post_content">
                        ...
                        <div class="post_info d-flex flex-row align-items-center justify-content-start">
                            <div class="post_author d-flex flex-row align-items-center justify-content-start">
                                <div class="post_author_name">Lưu Trường Hải Lân
                                </div>
                            </div>
