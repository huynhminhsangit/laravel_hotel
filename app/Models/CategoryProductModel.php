...
{
    use NodeTrait;
    protected $fillable       = ['name', 'created', 'created_by', 'modified', 'modified_by', 'status', 'is_home', 'display'];
    protected $table          = 'category_product';
    protected $controllerName = 'category-product';
    ...
    public function listItems($params = null, $options = null)
    {
        ...
        if ($options['task'] == "admin-list-items") {
            $query = self::select('id', 'name', 'status', 'is_home', 'display', 'created', 'created_by', 'modified', 'modified_by');
