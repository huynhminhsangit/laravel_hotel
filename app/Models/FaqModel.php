...
class FaqModel extends AdminModel
{
    ...
    public function listItems($params = null, $options = null)
    {
        ...
        if ($options['task'] == "admin-list-items") {
            $query = $this->select('id', 'status', 'ordering', 'answer', 'question','created', 'created_by', 'modified', 'modified_by','category_id');
    ...
    public function getItem($params = null, $options = null)
    {
        ...
        if ($options['task'] == 'get-item') {
            $result = self::select('id', 'status', 'ordering', 'answer', 'question','category_id')->where('id', $params['id'])->first();
        }
        if ($options['task'] == 'get-all-item') {
            $result = self::select('id', 'ordering', 'answer', 'question')->where('status', 'active')->get();
        }
        return $result;
    }
    ...
    public function saveItem($params = null, $options = null)
    {
        ...
        if ($options['task'] == 'change-category') {
            $update = self::where('id', $params['id'])->update(['category_id' => $params['category_id']]);
            if ($update) $typeMessage = true;
            else $typeMessage = false;
            $result = [
                'id'          => $params['id'],
