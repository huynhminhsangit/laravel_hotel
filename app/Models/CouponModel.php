...
class CouponModel extends AdminModel
{
    ...
    public function listItems($params = null, $options = null)
    {
        ...
        if ($options['task'] == "admin-list-items") {
            $query = $this->select('id', 'code', 'type', 'value','start', 'end','total', 'total_use','start_price', 'end_price');
    ...
    public function getItem($params = null, $options = null)
    {
        ...
        if ($options['task'] == 'get-item') {
            $result = self::select('id', 'code', 'type', 'value','start', 'end','total', 'total_use','start_price', 'end_price')->where('id', $params['id'])->first();
        }
